...
class MemberSettings extends StatefulWidget {
  MemberSettings({this.username, this.level,this.email});
  final String username,level,email;
  @override
  State<StatefulWidget> createState() { return new MemberSettingsState();}
}

class MemberSettingsState extends State<MemberSettings>{
  @override
              ...
              child: ListView(
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => MemberSettings(username: widget.username, level: "member", email: widget.email,)));
                    },
                  ),
             ...
             Container(
               ...
               child: SingleChildScrollView(
                   child: Column(
                     ...
                     children: [
                       Text(widget.level.toUpperCase()+" Settings".toUpperCase(), style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20.0, color: kPrimaryColor, backgroundColor: kPrimaryLightColor,),),
                       RoundedInputField(
                         controller: name,
