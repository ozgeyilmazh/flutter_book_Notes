...
import 'package:flutter_book_notes/Screens/Admin/admin_add_book_screen.dart';
...
class AdminScreen extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() { return new AdminScreenState();}
}
...
class AdminScreenState extends State<AdminScreen>{
  ...
  addPersonalBookList(user, bookId, bookName, bookAuthor) async{
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          Scaffold(
            appBar: AppBar(
              title: new Text("Welcome Admin:  "+widget.username, style: new TextStyle(fontSize: 15.0),),
              ...
              actions: <Widget>[
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AdminAddBookScreen(username: widget.username, email: emailList[0]['email'],)));
                  },
                ),
              ...
              child: ListView(
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => BookList(username: widget.username, level: "admin", email: emailList[0]['email'],)));
                    },
                  ),
                  ListTile(
                    title: Text("Settings"),
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => AdminSettings(username: widget.username, level: "admin", email: emailList[0]['email'],)));
                    },
                  ),
    ...
    return ListTile(
      ...
      trailing: RaisedButton(
        ...
        onPressed: () {
          ...
          addPersonalBookList(user,book_id, books_name,author);
        },
      ),
    );
  }
